...
<head>
  ...
  <style>
    ...
    .nc-body .ep-punte{{font-size:.95rem;line-height:1.7;margin-top:26px;padding-top:18px;border-top:1px solid var(--stone);color:var(--warm)}}
    .nc-body .ep-punte a{{color:var(--terra);text-decoration:none;border-bottom:1px solid rgba(198,122,84,.35)}}
    .nc-body .ep-punte a:hover{{border-bottom-color:var(--terra)}}
